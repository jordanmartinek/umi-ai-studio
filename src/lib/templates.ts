...
export const TEMPLATES: PromptTemplate[] = [
  // --- Photography (image generator) ---------------------------------
  {
    ...
    selections: {
      ...
      style: ["luxury-product-photography", "editorial-photography"],
  ...
  },
  {
    ...
    selections: {
      ...
      style: ["flat-lay-style", "minimalist"],
  ...
  },
  {
    ...
    selections: {
      ...
      motionType: ["falling-particles", "fabric-flowing"],
      pacing: ["6-seconds"],
      mood: ["dreamy", "elegant"],
      lighting: ["golden-hour"],
      palette: ["gold", "warm-neutrals"],
  ...
  },
  {
    ...
    selections: {
      subject: ["necklace"],
      personality: ["emotional", "heartfelt"],
      length: ["medium"],
      cta: ["tag-a-friend"],
  ...
  },
  {
    ...
    selections: {
      subject: ["brand"],
      personality: ["inspirational", "emotional"],
      length: ["short"],
      cta: ["save-this-post"],
      audience: ["women"],
      emotion: ["inspiration"],
